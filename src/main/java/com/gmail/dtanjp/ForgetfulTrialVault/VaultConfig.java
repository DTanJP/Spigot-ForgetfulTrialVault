...
public class VaultConfig {
	...
	public static void SAVE_CONFIG() {
		...
		config.setComments("PRINT_TIME_REMAINING", List.of("If there is a delay on the vault, should it send a message to the player letting them know how much time left"));
